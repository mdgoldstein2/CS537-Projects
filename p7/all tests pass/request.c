...
// handle a request
void requestHandle(int fd, shm_entry *tracker)
{
  ...
  if (is_static) {
    ...
    tracker->static_reqs++;  // increment number of static requests handled
  } else {
    ...
    tracker->dynamic_reqs++;  // increment number of dynamic reuqests handled
  }
}
