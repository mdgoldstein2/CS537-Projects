 ...
 * methods for any special output, opens the file to be searched (if specified),
 * and calls method to print out any lines in the file that start with the
 * given prefix string.
 * 
...
int main(int argc, char* argv[]) {
    ...
    char *pref_string = NULL;  // string all printed lines start with
    ...
    pref_string = argv[optind];  // get the string to be used

    // print out all lines that start with the given string
    PrintIfPrefix(dictionary, pref_string);
